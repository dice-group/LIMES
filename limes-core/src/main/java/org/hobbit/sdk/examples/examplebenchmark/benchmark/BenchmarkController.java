...
public class BenchmarkController extends AbstractBenchmarkController {
	...
	public void init() throws Exception {
		...
		envVariables = (String[]) ArrayUtils
			.add(DEFAULT_EVAL_STORAGE_PARAMETERS, "HOBBIT_RABBIT_HOST=" + this.rabbitMQHostName);
	...
	protected void executeBenchmark() throws Exception {
		logger.debug(
			"executeBenchmark(sending TASK_GENERATOR_START_SIGNAL & DATA_GENERATOR_START_SIGNAL)");
