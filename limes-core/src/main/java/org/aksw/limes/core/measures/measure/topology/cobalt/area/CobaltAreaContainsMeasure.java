 ...
 */
public class CobaltAreaContainsMeasure extends AMeasure {
    @Override
    public double getSimilarity(Object object1, Object object2) {
        ...
        return new CobaltAreaMatcher().relate(sGeo.getEnvelopeInternal(), tGeo.getEnvelopeInternal(), CobaltMeasures.CONTAINS) ? 1d : 0d;
    }
