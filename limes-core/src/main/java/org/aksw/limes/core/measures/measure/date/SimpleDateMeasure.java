...
/**
 * An implementation of the {@link DateMeasure} to compute the similarity of dates as a asymptotic mapping of the a in days to a similarity value
 * in [0, 1]. Whereas, let <i>dayDiff</i> be a difference of two dates measured in number of days. The similarity value is
 * computed as e^(-0.005*dayDiff). The following table shows some similarity values...
 * <table>
 * <tr><th>Difference in number of days</th><th>sim value</th></tr>
 * <tr><td>0</td><td>1.0</td></tr>
 * <tr><td>1</td><td>0.9950124791926823</td></tr>
 * <tr><td>2</td><td>0.9900498337491681</td></tr>
 * <tr><td>5</td><td>0.9753099120283326</td></tr>
 * <tr><td>10</td><td>0.951229424500714</td></tr>
 * <tr><td>365 (1 year)</td><td>0.1612176441297768</td></tr>
 * <tr><td>730 (2 years)</td><td>0.02599112877875535</td></tr>
 * <tr><td>1095 (3 years)</td><td>0.004190228549984578</td></tr>
 * </table>
 *
 * For a more human-centric similarity implementation please see {@link DayMeasure}
...
//    	   System.out.println("Similarity of Dates("+d1+" - "+d2+") == "+sim);
	...
	@Override
	public double getSimilarity(Instance a, Instance b, String property1,
			String property2) {
		Date d1=null; Date d2=null;
		long diff = 0; boolean set = false;
...
//		 	System.out.println("Similarity of Dates("+d1+" - "+d2+") == "+sim);
	...
	/**
	 * Computes similarity value of this {@link DateMeasure} based upon the difference of two dates in days. Other implementations should 
	 * override this method to provide their similarity implementation.
	 * @param dayDifference
