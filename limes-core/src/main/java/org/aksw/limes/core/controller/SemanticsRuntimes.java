...
public class SemanticsRuntimes {

    static Logger logger = LoggerFactory.getLogger(SemanticsRuntimes.class);
    ...
    public ACache source = null;
    public ACache target = null;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            SemanticsRuntimes controller = new SemanticsRuntimes();
