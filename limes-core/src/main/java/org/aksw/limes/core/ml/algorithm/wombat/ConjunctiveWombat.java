...
public class ConjunctiveWombat extends Wombat {
     ...
     * @param minCoverage
     */
    public ConjunctiveWombat(Cache sourceCache, Cache targetCache, AMapping examples, Configuration configuration) {
     ...
     */
    public static AMapping sampleReference(AMapping reference, double fraction) {
        ...
        //get data
        AMapping sample = MappingFactory.createMapping(MappingType.DEFAULT);
        int count = 0;
