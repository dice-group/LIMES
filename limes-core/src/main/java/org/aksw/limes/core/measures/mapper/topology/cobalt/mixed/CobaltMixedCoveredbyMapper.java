 ...
 */
public class CobaltMixedCoveredbyMapper extends AMapper implements ITopologicRelationMapper {

    @Override
    public AMapping getMapping(Set<Polygon> sourceData, Set<Polygon> targetData) {
        return Cobalt.getMapping(sourceData, targetData, CobaltMeasures.COVEREDBY, new CobaltMixedMatcher());
    }
    ...
    public AMapping getMapping(ACache source, ACache target, String sourceVar, String targetVar, String expression, double threshold) {
        return Cobalt.getMapping(source, target, sourceVar, targetVar, expression, threshold, CobaltMeasures.COVEREDBY, new CobaltMixedMatcher());
    }
    ...
    public String getName() {
        return "top_cobalt_mixed_coveredby";
    }
