...
public class McNemarsTest {
	...
	public static int getSuccesses(AMapping a, AMapping b, AMapping reference) {
		AMapping aRight = CrispSetOperations.INSTANCE.intersection(a, reference);
		AMapping bWrong = CrispSetOperations.INSTANCE.difference(reference, b);
		return CrispSetOperations.INSTANCE.intersection(aRight, bWrong).getSize();
	}
