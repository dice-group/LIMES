...
public class DuringReverseMeasure extends TemporalMeasure {
    private static final Logger logger = LoggerFactory.getLogger(DuringReverseMeasure.class.getName());
     ...
     * dates. If the first instance has a end date higher than the end date of
     * the second instance and its begin date is lower than the begin date of the
    ...
    public double getSimilarity(Instance instance1, Instance instance2, String property1, String property2) {
        ...
        try {
            ...
            logger.error(
                    "DuringReverse measure requires both begin and end date of the event. End date property is missing. Exiting..");
            System.exit(1);
        }
