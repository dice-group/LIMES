...
public class ResilientSparqlQueryModule extends SparqlQueryModule implements IQueryModule {
     ...
     *
     * @param cache
     *         The cache in which the content on the SPARQL endpoint is to be written
     * @param sparql
     *         True if the endpoint is a remote SPARQL endpoint, else assume that is is a jena model
     */
