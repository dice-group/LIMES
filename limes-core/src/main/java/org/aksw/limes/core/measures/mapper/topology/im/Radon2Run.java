...
public class Radon2Run {
	...
	public static void main(String[] args) throws ParseException {
		...
		String in1=args[1];//"/home/abddatascienceadmin/abdullah-2018/clc/datasets_3/nuts.nt";//
		String in2=args[2];//"/home/abddatascienceadmin/abdullah-2018/clc/datasets_3/nuts.nt";//
		...
		r2WithoutSimpilifcation = R2.getMapping(sourceWithoutSimplification,targetWithoutSimplification, "?x", "?y", "top_within(x.asWKT, y.asWKT)", 1.0d);
		...
		r2WithSimpilifcation= R2.getMapping(sourceWithSimplification, targetWithSimplification, "?x", "?y", "top_within(x.asWKT, y.asWKT)", 1.0d);
		...
		System.out.println("Simp. Par., Rel.,Simp. Time  , FG , RG , PG, F , R  , P , T TIME OF R2 without Simp., T SIZE OF R2 without, T TIME OF R2 with Simp., T SIZE OF R2 with");
		System.out.println(parameter+", INTERSECT , "+simpT+", "+f1+", "+r1+","+p1+","+f11+","+r11+","+p11+","+(t2-t)+","+rwout +","+rwitht+","+rw);
		System.out.println(parameter+", CONTAINS  , "+simpT+", "+f2+", "+r2+","+p2+","+f22+","+r22+","+p22+","+(t2-t)+","+rwout +","+rwitht+","+rw);
		System.out.println(parameter+", COVEREDBY , "+simpT+", "+f3+", "+r3+","+p3+","+f33+","+r33+","+p33+","+(t2-t)+","+rwout +","+rwitht+","+rw);
		System.out.println(parameter+", COVERS    , "+simpT+", "+f4+", "+r4+","+p4+","+f44+","+r44+","+p44+","+(t2-t)+","+rwout +","+rwitht+","+rw);
		System.out.println(parameter+", CROSSES   , "+simpT+", "+f5+", "+r5+","+p5+","+f55+","+r55+","+p55+","+(t2-t)+","+rwout +","+rwitht+","+rw);
		System.out.println(parameter+", OVERLAPS  , "+simpT+", "+f6+", "+r6+","+p6+","+f66+","+r66+","+p66+","+(t2-t)+","+rwout +","+rwitht+","+rw);
		System.out.println(parameter+", EQUALS    , "+simpT+", "+f7+", "+r7+","+p7+","+f77+","+r77+","+p77+","+(t2-t)+","+rwout +","+rwitht+","+rw);
		System.out.println(parameter+", WITHIN    , "+simpT+", "+f8+", "+r8+","+p8+","+f88+","+r88+","+p88+","+(t2-t)+","+rwout +","+rwitht+","+rw);
		System.out.println(parameter+", TOUCHES   , "+simpT+", "+f9+", "+r9+","+p9+","+f99+","+r99+","+p99+","+(t2-t)+","+rwout +","+rwitht+","+rw);
