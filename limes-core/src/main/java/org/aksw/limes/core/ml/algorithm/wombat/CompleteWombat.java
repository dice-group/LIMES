...
public class CompleteWombat extends Wombat {
     ...
     * @param minCoverage
     */
    public CompleteWombat(Cache sourceCache, Cache targetChache, AMapping examples, Configuration configuration) {
     ...
     * @author sherif
     */
    private RefinementNode createNode(String metricExpr, AMapping map) {
    ...
    private RefinementNode createNode(String metricExpr) {
        AMapping map = getMapingOfMetricExpression(metricExpr);
