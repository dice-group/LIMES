...
public class UnsupervisedCompleteWombat extends Wombat {
    ...
    private Map<String, AMapping> diffs;
     ...
     * @param minCoverage
     */
    public UnsupervisedCompleteWombat(Cache sourceCache, Cache targetCache, AMapping examples, Configuration configuration) {
     ...
     * @author sherif
     */
    private Map<String, AMapping> getClassifiersDiffPermutations(List<ExtendedClassifier> c) {
    ...
    private List<RefinementNode> refine(final Tree<RefinementNode> node) {
        ...
        AMapping childMap = MappingFactory.createMapping(MappingType.DEFAULT);
    ...
    private List<RefinementNode> createDisjunctionsWithDiffNodes(Tree<RefinementNode> node) {
        ...
        for (String diffExpr : diffs.keySet()) {
            ...
            AMapping nodeMaping = MappingFactory.createMapping(MappingType.DEFAULT);
            if (RefinementNode.isSaveMapping()) {
    ...
    private RefinementNode createNode(String metricExpr) {
        AMapping mapping = getMapingOfMetricExpression(metricExpr);
