...
public class runNlg {
	...
	for(String t:temp) {
		...
		similarityMeasures2.add("Koeln");


		similarityMeasures3.add("soundex");
		similarityMeasures3.add("ratcliff");
		similarityMeasures3.add("caverphone1");
		similarityMeasures3.add("daitchmokotoff");
		similarityMeasures3.add("refinedsoundex");
		similarityMeasures3.add("meta");
		similarityMeasures3.add("doublemeta");
									...
									for(String sim3: similarityMeasures3) {
										for(String m:measures) {
											for(String m1:measures1) {
												...
												String eithLevelLs=op+"("+sevniththLevelLs1+"|"+m+","+firstLevelLS+"|"+m1+")";
												String ninthLevelLs=op+"("+thirdLevelLS+"|"+m+","+fifithLevelLS+"|"+m1+")";

												//linkSpec.readSpec(eithLevelLs, 0.7);
												...
												linkspecs.add(eithLevelLs);
												linkspecs.add(ninthLevelLs);
												//linkspecs.add(test);
											}
										}
									}
		...
		File fout = new File("/home/abdullah/dataset/lsverbalization1MB.csv");
