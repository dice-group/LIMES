...
public class StringPreprocessingCommand extends CommandGene implements IMutateable,
	 ...
	 * @param a_config GPConfiguration, in most cases a LinkSpecGeneticLearnerConfig.
	 * @param function The preprocessing function, e.g. "lowercase"
	 * @param subReturnType A sub return type to distinguish from other commands.
	 ...
	 * @param a_config GPConfiguration, in most cases a LinkSpecGeneticLearnerConfig.
	 * @param a_returnType Defines the return type.
	 * @param function The preprocessing function, e.g. "lowercase"
	 * @param subReturnType A sub return type to distinguish from other commands.
	 * @throws InvalidConfigurationException
	 * @param is_mutable 
