...
public class PhoneticStringMeasureEvaluation {
	...
	public static void main(String[] args) throws UnsupportedMLImplementationException {
		...
		AMapping wombatMapping=wombatUnsupervised(eval.getSourceCache(), eval.getTargetCache());
		double f=fmeausre.calculate(wombatMapping, new GoldStandard(eval.getReferenceMapping()));
		double r=fmeausre.recall(wombatMapping, new GoldStandard(eval.getReferenceMapping()));
		double p=fmeausre.precision(wombatMapping, new GoldStandard(eval.getReferenceMapping()));
...
//
	...
	public static AMapping wombatUnsupervised(ACache sc,  ACache tc) throws UnsupportedMLImplementationException {
	      ...
	      //  wombatSimpleU.init(null, sc, tc);
			...
			LearningParameter lp =  new LearningParameter("atomic measures", measures, MeasureType.class, 0, 0, 0, AWombat.PARAMETER_ATOMIC_MEASURES);
			lps.add(lp);
	     ...
	     //   lp.add(new LearningParameter("atomic measures", measures, MeasureType.class, 0, 0, 0, AWombat.PARAMETER_ATOMIC_MEASURES));
	        ...
	        System.out.println("ls is "+mlModel.getLinkSpecification().getFullExpression());
