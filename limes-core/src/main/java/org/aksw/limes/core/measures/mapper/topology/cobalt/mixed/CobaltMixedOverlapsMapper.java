 ...
 */
public class CobaltMixedOverlapsMapper extends AMapper implements ITopologicRelationMapper {

    @Override
    public AMapping getMapping(Set<Polygon> sourceData, Set<Polygon> targetData) {
        return Cobalt.getMapping(sourceData, targetData, CobaltMeasures.OVERLAPS, new CobaltMixedMatcher());
    }
    ...
    public AMapping getMapping(ACache source, ACache target, String sourceVar, String targetVar, String expression, double threshold) {
        return Cobalt.getMapping(source, target, sourceVar, targetVar, expression, threshold, CobaltMeasures.OVERLAPS, new CobaltMixedMatcher());
    }
    ...
    public String getName() {
        return "top_cobalt_mixed_overlaps";
    }
}
