...
public interface IFilter {
     ...
     * @return Mapping, that satisfies condition >= threshold
     */
    public AMapping filter(AMapping map, String condition, double threshold, double mainThreshold, Cache source, Cache target, String sourceVar,
                           String targetVar);

    /**
     * Reverse filter for mapping using a condition and two thresholds as filtering
     * criterion
     *
     * @param map,
     *         Map bearing the results of Link Specification
     ...
     * @return Mapping, that satisfies condition < threshold
     */
    public AMapping reversefilter(AMapping map, String condition, double threshold, double mainThreshold, Cache source, Cache target, String sourceVar,
                                  String targetVar);
