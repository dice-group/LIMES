 ...
 * @version 1.0
 */
public class OverlapsMeasure extends TemporalMeasure {
    private static final Logger logger = LoggerFactory.getLogger(OverlapsMeasure.class.getName());
    ...
    public double getSimilarity(Object object1, Object object2) {
        ...
        if ((beginDate1 < beginDate2) && (endDate1 < endDate2) && (endDate1 > beginDate2))
            sim = 1;
        else
            sim = 0;
     ...
     * of the second instance and its end date is lower than the end date of the
     * second instance and its end date is higher than the begin date of the
    ...
    public double getSimilarity(Instance instance1, Instance instance2, String property1, String property2) {
        ...
        try {
            ...
            logger.error(
                    "Overlaps measure requires both begin and end date of the event. End date property is missing. Exiting..");
            System.exit(1);
        }
