...
public class EdgeCountingSemanticMapperThreading extends AMapper{

    static Logger logger = LoggerFactory.getLogger(EdgeCountingSemanticMapperThreading.class);
    ...
    public class SimilarityThread implements Callable<Pair<Pair<String, String>, Double>> {
        ...
        SemanticDictionary dictionary = null;
        ...
        public SimilarityThread(String expression, Instance s, Instance t, String prop1, String prop2, SemanticDictionary dict) {
            ...
            measure.setDictionaryFlag(false);
        }
