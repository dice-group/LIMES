 ...
 * dubbed pseudo Reference F-Measure.<br> Thereby, not relying 
 * on any gold standard. The basic idea is to measure the quality 
...
public class PseudoRefFMeasure extends PseudoFMeasure {
    ...
    /** 
     * The method calculates the pseudo reference F-Measure of the machine learning 
    ...
    /** 
     * The method calculates the pseudo reference recall of the machine learning 
    ...
    /** 
     * The method calculates the pseudo reference precision of the machine learning 
     * predictions compared to a gold standard
     * 
     * @param predictions The predictions provided by a machine learning algorithm
     * @param goldStandard It contains the gold standard (reference mapping) 
