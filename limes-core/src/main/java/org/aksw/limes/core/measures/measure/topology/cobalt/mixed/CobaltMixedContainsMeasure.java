 ...
 */
public class CobaltMixedContainsMeasure extends AMeasure {
    @Override
    public double getSimilarity(Object object1, Object object2) {
        ...
        return new CobaltMixedMatcher().relate(sGeo.getEnvelopeInternal(), tGeo.getEnvelopeInternal(), CobaltMeasures.CONTAINS) ? 1d : 0d;
    }
