 ...
 */
public class CobaltAreaDisjointMapper extends AMapper implements ITopologicRelationMapper {

    @Override
    public AMapping getMapping(Set<Polygon> sourceData, Set<Polygon> targetData) {
        return Cobalt.getMapping(sourceData, targetData, CobaltMeasures.DISJOINT, new CobaltAreaMatcher());
    }
    ...
    public AMapping getMapping(ACache source, ACache target, String sourceVar, String targetVar, String expression, double threshold) {
        return Cobalt.getMapping(source, target, sourceVar, targetVar, expression, threshold, CobaltMeasures.DISJOINT, new CobaltAreaMatcher());
    }
    ...
    public String getName() {
        return "top_cobalt_area_disjoint";
    }
}
