 ...
 */
public class CobaltAreaIntersectsMapper extends AMapper implements ITopologicRelationMapper {

    @Override
    public AMapping getMapping(Set<Polygon> sourceData, Set<Polygon> targetData) {
        return Cobalt.getMapping(sourceData, targetData, CobaltMeasures.INTERSECTS, new CobaltAreaMatcher());
    }
    ...
    public AMapping getMapping(ACache source, ACache target, String sourceVar, String targetVar, String expression, double threshold) {
        return Cobalt.getMapping(source, target, sourceVar, targetVar, expression, threshold, CobaltMeasures.INTERSECTS, new CobaltAreaMatcher());
    }
    ...
    public String getName() {
        return "top_cobalt_area_intersects";
    }
}
