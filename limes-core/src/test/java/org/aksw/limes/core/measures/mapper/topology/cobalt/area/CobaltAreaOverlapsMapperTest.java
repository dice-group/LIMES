...
public class CobaltAreaOverlapsMapperTest {
    ...
    public void testGetMapping() throws Exception {
        ...
        AMapper mapper = new CobaltAreaOverlapsMapper();
        assertEquals("Expect mapping generated by CobaltAreaOverlapsMapper to be equal to reference mapping",
                mapper.getMapping(s, t, "?x", "?y", "top_cobalt_area_overlaps(x.asWKT, y.asWKT)", 1.0d), referenceMapping);
    }
}