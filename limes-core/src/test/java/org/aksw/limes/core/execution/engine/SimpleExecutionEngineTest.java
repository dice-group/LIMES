...
public class SimpleExecutionEngineTest {
	...
	public AMapping einstUnion = MappingFactory.createDefaultMapping();
	...
	private void prepareEinsteinGoldData() {
		einstUnion.add("S1", "T1", 0.5);
		einstUnion.add("S2", "T2", 1.0);
		einstUnion.add("S4", "T4", 1.0);
		einstUnion.add("S5", "T5", 1.0);

		einstIntersection.add("S2", "T2", 1.0);
		einstIntersection.add("S4", "T4", 0.666666667);
	...
	public void einsteinUnion() {
		...
		Instruction run2 = new Instruction(Command.RUN,
				"trigrams(x.name,y.name)", "0.4", -1, -1, 1);
		Instruction union = new Instruction(Command.EINSTEINTCO, "", "0.0", 0,
				1, 2);
		...
		assertEquals(mUnion, mUnion2);
		assertEquals(einstUnion, mUnion);
	...
	@Test
	public void einsteinIntersection() {
		SimpleExecutionEngine ee = new SimpleExecutionEngine(source, target,
				"?x", "?y");
		Instruction run1 = new Instruction(Command.RUN,
				"qgrams(x.surname,y.surname)", "0.4", -1, -1, 0);
		Instruction run2 = new Instruction(Command.RUN,
				"trigrams(x.name,y.name)", "0.4", -1, -1, 1);
		Instruction intersection = new Instruction(Command.EINSTEINT, "", "0.4",
				0, 1, 2);
		...
		assertEquals(mIntersection, mIntersection2);
		assertEquals(einstIntersection, mIntersection);
	...
	@Test
	public void einsteinDifference() {
		SimpleExecutionEngine ee = new SimpleExecutionEngine(source, target,
				"?x", "?y");
		Instruction run1 = new Instruction(Command.RUN,
				"qgrams(x.surname,y.surname)", "0.4", -1, -1, 0);
		Instruction run2 = new Instruction(Command.RUN,
				"trigrams(x.name,y.name)", "0.4", -1, -1, 1);
		Instruction difference = new Instruction(Command.EINSTEINDIFF, "",
				"0.4", 0, 1, 2);
