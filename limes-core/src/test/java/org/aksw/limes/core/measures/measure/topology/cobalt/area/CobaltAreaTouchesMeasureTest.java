...
public class CobaltAreaTouchesMeasureTest {

    @Test
    public void testGetSimilarity() throws Exception {
        AMeasure measure = new CobaltAreaTouchesMeasure();
        ...
        //False positive of cobalt. It cannot distinguish between disjoint and meet with the area function
