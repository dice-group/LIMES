...
public class CobaltMixedOverlapsMapperTest {
    ...
    public void testGetMapping() throws Exception {
        ...
        AMapper mapper = new CobaltMixedOverlapsMapper();
        assertEquals("Expect mapping generated by CobaltMixedOverlapsMapper to be equal to reference mapping",
                mapper.getMapping(s, t, "?x", "?y", "top_cobalt_mixed_overlaps(x.asWKT, y.asWKT)", 1.0d), referenceMapping);
    }
}