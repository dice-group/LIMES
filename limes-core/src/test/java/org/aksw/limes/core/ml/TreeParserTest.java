...
public class TreeParserTest {
	...
	public void parseTreePrefixTestComplexTree() throws Exception{
		...
		Object[] parameters = {tree};
		LinkSpecification ls3 = (LinkSpecification) parseTreePrefix.invoke(tp, parameters);
		assertEquals("(null, 0.0, OR, null,){(null, 0.0, AND, null,){(null, 0.0, MINUS, null,){(trigrams(x.title,y.name)|0.01, 0.01, null, null),(trigrams(x.title,y.name)|0.89, 0.888889, null, null),},(null, 0.0, OR, null,){(null, 0.0, AND, null,){(null, 0.0, MINUS, null,){(jaccard(x.description,y.description)|0.01, 0.01, null, null),(jaccard(x.description,y.description)|0.49, 0.487179, null, null),},(null, 0.0, AND, null,){(null, 0.0, MINUS, null,){(exactmatch(x.manufacturer,y.manufacturer)|0.01, 0.01, null, null),(exactmatch(x.manufacturer,y.manufacturer)|0.00, 0.0, null, null),},(null, 0.0, AND, null,){(null, 0.0, MINUS, null,){(jaccard(x.title,y.name)|0.01, 0.01, null, null),(jaccard(x.title,y.name)|0.23, 0.230769, null, null),},(null, 0.0, AND, null,){(jaro(x.manufacturer,y.manufacturer)|0.10, 0.1, null, null),(null, 0.0, MINUS, null,){(cosine(x.manufacturer,y.manufacturer)|0.01, 0.01, null, null),(cosine(x.manufacturer,y.manufacturer)|0.50, 0.5, null, null),},},},},},(null, 0.0, AND, null,){(jaccard(x.description,y.description)|0.49, 0.487179, null, null),(null, 0.0, AND, null,){(cosine(x.manufacturer,y.manufacturer)|0.29, 0.288675, null, null),(cosine(x.title,y.name)|0.61, 0.606977, null, null),},},},},(trigrams(x.title,y.name)|0.89, 0.888889, null, null),}", ls3.toStringOneLine());
