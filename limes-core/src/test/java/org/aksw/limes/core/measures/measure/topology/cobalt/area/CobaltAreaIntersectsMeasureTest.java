...
public class CobaltAreaIntersectsMeasureTest {

    @Test
    public void testGetSimilarity() throws Exception {
        AMeasure measure = new CobaltAreaIntersectsMeasure();
        //False positive of cobalt. It cannot distinguish between disjoint and meet with the area function and meet implies intersects, so cobalt says they intersect each other
