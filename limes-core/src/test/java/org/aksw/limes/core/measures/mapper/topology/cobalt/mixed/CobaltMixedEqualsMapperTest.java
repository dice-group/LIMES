...
public class CobaltMixedEqualsMapperTest {
    ...
    public void testGetMapping() throws Exception {
        ...
        AMapper mapper = new CobaltMixedEqualsMapper();
        assertEquals("Expect mapping generated by CobaltMixedEqualsMapper to be equal to reference mapping",
                mapper.getMapping(s, t, "?x", "?y", "top_cobalt_mixed_equals(x.asWKT, y.asWKT)", 1.0d), referenceMapping);
    }
}