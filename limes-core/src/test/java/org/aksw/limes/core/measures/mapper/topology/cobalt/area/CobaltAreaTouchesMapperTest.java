...
public class CobaltAreaTouchesMapperTest {
    ...
    public void testGetMapping() throws Exception {
        ...
        AMapper mapper = new CobaltAreaTouchesMapper();
        assertEquals("Expect mapping generated by CobaltAreaTouchesMapper to be equal to reference mapping",
                mapper.getMapping(s, t, "?x", "?y", "top_cobalt_area_touches(x.asWKT, y.asWKT)", 1.0d), referenceMapping);
    }
}