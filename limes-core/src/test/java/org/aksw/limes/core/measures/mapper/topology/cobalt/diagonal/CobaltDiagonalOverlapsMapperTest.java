...
public class CobaltDiagonalOverlapsMapperTest {
    ...
    public void testGetMapping() throws Exception {
        ...
        AMapper mapper = new CobaltDiagonalOverlapsMapper();
        assertEquals("Expect mapping generated by CobaltDiagonalOverlapsMapper to be equal to reference mapping",
                mapper.getMapping(s, t, "?x", "?y", "top_cobalt_diagonal_overlaps(x.asWKT, y.asWKT)", 1.0d), referenceMapping);
    }
}