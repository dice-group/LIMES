...
public class CobaltMixedTouchesMapperTest {
    ...
    public void testGetMapping() throws Exception {
        ...
        AMapper mapper = new CobaltMixedTouchesMapper();
        assertEquals("Expect mapping generated by CobaltMixedTouchesMapper to be equal to reference mapping",
                mapper.getMapping(s, t, "?x", "?y", "top_cobalt_mixed_touches(x.asWKT, y.asWKT)", 1.0d), referenceMapping);
    }
}