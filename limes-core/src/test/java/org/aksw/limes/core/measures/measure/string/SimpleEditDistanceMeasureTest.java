...
public class SimpleEditDistanceMeasureTest {
    ...
    public void testGetSimilarity() {
        ...
        assertEquals(1.0 - 5.0 / measure.getWorstCaseCost(3, 3),
            measure.getSimilarity("abc", "bca"), eps);
        assertEquals(1.0 - 10.0 / measure.getWorstCaseCost(4, 5),
            measure.getSimilarity("abcd", "xbcyz"), eps);
