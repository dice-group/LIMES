...
public class FinishesMapperTest {
    public ACache source = new MemoryCache();
    public ACache target = new MemoryCache();

    private static final Logger logger = LoggerFactory.getLogger(FinishesMapperTest.class);
    @Before
    public void setUp() {
    ...
    public void simpleLS() {
        ...
        LinkSpecification ls = new LinkSpecification(
                "tmp_finishes(x.beginsAtDateTime|endsAtDateTime,y.b|e)",
                1.0);
    ...
    public void similarity() {
        ...
        for (Instance s : source.getAllInstances()) {
            for (Instance t : target.getAllInstances()) {
                FinishesMeasure measure = new FinishesMeasure();
