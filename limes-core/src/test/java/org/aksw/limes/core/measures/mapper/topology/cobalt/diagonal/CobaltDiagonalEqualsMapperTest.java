...
public class CobaltDiagonalEqualsMapperTest {
    ...
    public void testGetMapping() throws Exception {
        ...
        AMapper mapper = new CobaltDiagonalEqualsMapper();
        assertEquals("Expect mapping generated by CobaltDiagonalEqualsMapper to be equal to reference mapping",
                mapper.getMapping(s, t, "?x", "?y", "top_cobalt_diagonal_equals(x.asWKT, y.asWKT)", 1.0d), referenceMapping);
    }
}