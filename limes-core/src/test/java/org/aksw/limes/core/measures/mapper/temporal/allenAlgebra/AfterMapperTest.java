...
public class AfterMapperTest {
	...
	LinkSpecification ls = new LinkSpecification(
		"tmp_after(x.beginsAtDateTime|endsAtDateTime,y.beginsAtDateTime|endsAtDateTime)", 1.0);
	...
	LinkSpecification ls2 = new LinkSpecification(
		"tmp_before(x.beginsAtDateTime|endsAtDateTime,y.beginsAtDateTime|endsAtDateTime)", 1.0);
