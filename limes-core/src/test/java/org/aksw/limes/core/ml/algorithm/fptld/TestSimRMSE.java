...
public class TestSimRMSE {

	public AMapping m1;
	public AMapping m2;
	public static final double gold = 1 - Math.sqrt(BigDecimal.valueOf(2.35)
			.divide(BigDecimal.valueOf(6.0), MappingOperations.SCALE, RoundingMode.HALF_UP).doubleValue());
