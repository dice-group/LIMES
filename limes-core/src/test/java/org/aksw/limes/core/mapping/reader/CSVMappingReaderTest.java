...
public class CSVMappingReaderTest {
	...
	public void csvMappingTestBugFix() {
		final String[] datasetsList = {DataSetChooser.DataSets.DBLPACM.toString(), DataSetChooser.DataSets.ABTBUY.toString(), DataSetChooser.DataSets.DBLPSCHOLAR.toString(), DataSetChooser.DataSets.AMAZONGOOGLEPRODUCTS.toString(), DataSetChooser.DataSets.DBPLINKEDMDB.toString(), DataSetChooser.DataSets.DRUGS.toString()};
