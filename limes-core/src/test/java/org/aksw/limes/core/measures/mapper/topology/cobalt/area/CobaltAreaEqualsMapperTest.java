...
public class CobaltAreaEqualsMapperTest {
    ...
    public void testGetMapping() throws Exception {
        ...
        AMapper mapper = new CobaltAreaEqualsMapper();
        assertEquals("Expect mapping generated by CobaltAreaEqualsMapper to be equal to reference mapping",
                mapper.getMapping(s, t, "?x", "?y", "top_cobalt_area_equals(x.asWKT, y.asWKT)", 1.0d), referenceMapping);
    }
}