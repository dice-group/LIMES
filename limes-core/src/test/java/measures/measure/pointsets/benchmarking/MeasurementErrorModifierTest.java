package measures.measure.pointsets.benchmarking;
...
import org.aksw.limes.core.measures.measure.pointsets.benchmarking.MeasurementErrorModifier;
...
public class MeasurementErrorModifierTest {
	...
	Polygon maltaNutsPoly1 = new Polygon("maltaNutsPoly1",
		Arrays.asList(new Point[] { maltaNutsP1, maltaNutsP2, maltaNutsP3, maltaNutsP4, maltaNutsP5 }));
	...
	Polygon maltaNutsPoly2 = new Polygon("maltaNutsPoly2",
		Arrays.asList(new Point[] { maltaNutsP6, maltaNutsP7, maltaNutsP8, maltaNutsP9 }));
